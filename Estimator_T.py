...
class RLS_EHGO_T:
      ...
      def EHGO_T(self,T, EHGO_T_input):
            s_ = EHGO_T_input
            ...
            x2_ob = x2_ob_ + T*(Fx + sig_x_ + self.a11/self.epsilon*(x2_ - x2_ob_))
            y2_ob = y2_ob_ + T*(Fy + sig_y_ + self.a11/self.epsilon*(y2_ - y2_ob_))
            z2_ob = z2_ob_ + T*(Fz + sig_z_ + self.b11/self.epsilon*(z2_ - z2_ob_))

            sig_x = sig_x_ + T*(self.a12/self.epsilon**2*(x2_ - x2_ob_))
            sig_y = sig_y_ + T*(self.a12/self.epsilon**2*(y2_ - y2_ob_))
            sig_z = sig_z_ + T*(self.b12/self.epsilon**2*(z2_ - z2_ob_))
